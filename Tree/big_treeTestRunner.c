...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_for_inserting_root_node_for_float");
	setup();
		test_for_inserting_root_node_for_float();
	tearDown();
	testEnded();
	testStarted("test_for_inserting_root_node_for_double");
	setup();
		test_for_inserting_root_node_for_double();
	tearDown();
	testEnded();
	testStarted("test_for_inserting_root_node_for_char");
	setup();
		test_for_inserting_root_node_for_char();
	tearDown();
	testEnded();
