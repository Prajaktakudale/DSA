...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_for_remove_process_between_two_processes");
	setup();
		test_for_remove_process_between_two_processes();
	tearDown();
	testEnded();
	testStarted("test_for_delete_first_process_from_schedular");
	setup();
		test_for_delete_first_process_from_schedular();
	tearDown();
	testEnded();
