...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_to_sort_the_int_elements_when_list_is_alredy_sorted_in_desending_order");
	setup();
		test_to_sort_the_int_elements_when_list_is_alredy_sorted_in_desending_order();
	tearDown();
	testEnded();
	...
	tearDown();
	testEnded();
	testStarted("test_to_sort_the_float_elements_when_list_is_alredy_sorted_in_desending_order");
	setup();
		test_to_sort_the_float_elements_when_list_is_alredy_sorted_in_desending_order();
	tearDown();
	testEnded();
	...
	tearDown();
	testEnded();
	testStarted("test_to_sort_the_double_elements_when_list_is_alredy_sorted_in_desending_order");
	setup();
		test_to_sort_the_double_elements_when_list_is_alredy_sorted_in_desending_order();
	tearDown();
	testEnded();
	...
	tearDown();
	testEnded();
	testStarted("test_to_sort_the_string_elements_when_list_is_alredy_sorted_in_desending_order");
	setup();
		test_to_sort_the_string_elements_when_list_is_alredy_sorted_in_desending_order();
	tearDown();
	testEnded();
